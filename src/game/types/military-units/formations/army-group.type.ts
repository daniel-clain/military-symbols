...
import { FieldMarshal, GeneralOfTheArmy } from "../../officers/general.type"
 ...
 * 
 */
export type ArmyGroup = Formation & {
  crosses: 5
  commandingOfficers: [FieldMarshal | GeneralOfTheArmy]
  echelonName: 'Army Group'
}